...
export default function ErrorRulePage() {
  ...
  return (
    <div className="errorrule-page">
      {/* 顶部标题卡 */}
      <Card className="errorrule-header-card" bordered={false}
        extra={
          <Space>
        ...
        title={
          <div className="errorrule-title">
            <span className="errorrule-title__icon">
              <BugOutlined />
            </span>
            <div className="errorrule-title__main">
              <h2>错误规则管理</h2>
              <p>把上游各厂商错误统一映射成平台错误码，运营无需改代码</p>
            </div>
          </div>
        }
      />
      ...
      {/* 顶部统计 */}
      <Row gutter={16} className="errorrule-stat-row">
        <Col xs={12} sm={6}>
          <Card className="stat-card --accent-blue" bordered={false}>
            <div className="stat-card__label">规则总数</div>
            <div className="stat-card__value">{stats.total}</div>
          </Card>
        </Col>
        <Col xs={12} sm={6}>
          <Card className="stat-card --accent-green" bordered={false}>
            <div className="stat-card__label">已启用</div>
            <div className="stat-card__value">{stats.enabled}</div>
          </Card>
        </Col>
        <Col xs={12} sm={6}>
          <Card className="stat-card --accent-violet" bordered={false}>
            <div className="stat-card__label">自定义规则</div>
            <div className="stat-card__value">{stats.custom}</div>
          </Card>
        </Col>
        <Col xs={12} sm={6}>
          <Card className="stat-card --accent-orange" bordered={false}>
            <div className="stat-card__label">覆盖错误码</div>
            <div className="stat-card__value">{stats.distinctErrors}</div>
          </Card>
        </Col>
      </Row>

      {/* 工具栏 */}
      <Card className="errorrule-toolbar" bordered={false}>
        <Form
          form={searchForm}
          layout="inline"
      ...
      {/* 主表格 */}
      <Card className="errorrule-table-card" bordered={false}>
        <Table
          rowKey="id"
          loading={loading}
          dataSource={list}
