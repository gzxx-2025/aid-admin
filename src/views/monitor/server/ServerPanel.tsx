      ...
      <Row gutter={[16, 16]}>
        <Col xs={24} md={12}>
          <Card
            ...
            title={
              <span>
                <span style={{ ...headerIconStyle, background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' }}>
                  <DatabaseOutlined />
                </span>
                CPU
              </span>
        ...
        <Col xs={24} md={12}>
          <Card
            ...
            title={
              <span>
                <span style={{ ...headerIconStyle, background: 'linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)' }}>
                  <HddOutlined />
                </span>
                内存
              </span>
        ...
        <Col xs={24} md={12}>
          <Card
            ...
            title={
              <span>
                <span style={{ ...headerIconStyle, background: 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)' }}>
                  <CloudServerOutlined />
                </span>
                服务器信息
              </span>
        ...
        <Col xs={24} md={12}>
          <Card
            ...
            title={
              <span>
                <span style={{ ...headerIconStyle, background: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)' }}>
                  <RocketOutlined />
                </span>
                Java 虚拟机信息
              </span>
