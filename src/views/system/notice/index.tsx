...
import { Button, Card, Col, Form, Input, Modal, Popconfirm, Radio, Row, Select, Space, Table, message } from 'antd';
import { DeleteOutlined, EditOutlined, PlusOutlined, SearchOutlined, NotificationOutlined } from '@ant-design/icons';
  ...
  return (
    <div className="crud-page">
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
        ...
        <div>
          <div style={{ fontSize: 18, fontWeight: 600 }}>通知公告</div>
          <div style={{ color: '#94a3b8', fontSize: 12 }}>发布系统公告与通知，支持富文本排版</div>
        </div>
      </div>
