...
const menuTypeColor: Record<string, string> = { M: '#1677ff', C: '#52c41a', F: '#faad14' };
...
export default function MenuManagePage() {
  ...
  const columns: ColumnsType<MenuRow> = [
    ...
    { title: '组件路径', dataIndex: 'component', width: 220, ellipsis: true },
    {
      ...
      align: 'center',
      render: (v: string) => (
        <span style={{ color: menuTypeColor[v] }}>{menuTypeLabel[v] || v}</span>
      )
    },
    {
      title: '状态',
              ...
              >
                {({ getFieldValue }) =>
                  getFieldValue('menuType') === 'C' ? (
                    ...
                    >
                      <Input placeholder='如：{"id":1}' maxLength={255} />
                    </Form.Item>
                  ) : null
                }
              </Form.Item>
