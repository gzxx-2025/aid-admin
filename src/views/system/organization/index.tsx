  ...
  return (
    <div className="crud-page" style={{ padding: 16 }}>
      <Tabs
        ...
        items={[
          { key: 'user', label: <span><UserOutlined /> 用户管理</span>, children: active === 'user' ? <UserPage /> : null },
          { key: 'role', label: <span><TeamOutlined /> 角色管理</span>, children: active === 'role' ? <RolePage /> : null },
