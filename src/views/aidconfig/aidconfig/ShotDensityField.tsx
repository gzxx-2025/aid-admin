...
const MODE_PREVIEWS = [
  ...
  { name: '标准模式', desc: '默认档位', color: '#667eea', bg: 'rgba(102, 126, 234, 0.08)', border: 'rgba(102, 126, 234, 0.25)' },
  { name: '细拆模式', desc: '重点戏份', color: '#764ba2', bg: 'rgba(118, 75, 162, 0.08)', border: 'rgba(118, 75, 162, 0.25)' }
];
