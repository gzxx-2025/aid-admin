        ...
        <div className="config-page__header">
          ...
          <div className="config-page__header-right">
            {!isSpecialSection && hasModified && (
              <>
                <Button size="small" icon={<UndoOutlined />} onClick={resetCurrentGroup}>
                  取消修改
                </Button>
                <Button
                  type="primary"
            ...
            {activeCategory === 'api_crypto' && (
              <Button size="small" type="primary" ghost icon={<KeyOutlined />} onClick={generateRsaKeyPair}>
                一键生成密钥对
              </Button>
            )}
            ...
            {!isSpecialSection && (
              <Button size="small" icon={<ReloadOutlined />} loading={loading} onClick={loadList}>
                刷新
              </Button>
            )}
          </div>
