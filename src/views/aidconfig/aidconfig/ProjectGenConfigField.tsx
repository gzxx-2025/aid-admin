...
function ModeBlockEditor({
  ...
  return (
    ...
    >
      <Row gutter={[12, 10]}>
        <Col span={24}>
          <div style={{ fontSize: 12, color: '#64748b', marginBottom: 4 }}>智能体</div>
          <Select
            showSearch
            allowClear
            ...
            notFoundContent={<span style={{ color: '#94a3b8' }}>该场景下暂无可选智能体</span>}
          />
        </Col>
        <Col span={24}>
          <div style={{ fontSize: 12, color: '#64748b', marginBottom: 4 }}>
            模型
            <span style={{ marginLeft: 6, color: '#94a3b8' }}>（按所选智能体绑定的模型池联动）</span>
            {loadingModels && (
        ...
        {imageScene && (
          <Col span={12}>
            <div style={{ fontSize: 12, color: '#64748b', marginBottom: 4 }}>清晰度</div>
            <Select
              allowClear
              ...
              notFoundContent={<span style={{ color: '#94a3b8' }}>该模型无可选清晰度</span>}
            />
          </Col>
        )}
        {imageScene && (
          <Col span={12}>
            <div style={{ fontSize: 12, color: '#64748b', marginBottom: 4 }}>画面比例</div>
            <Select
              allowClear
              ...
              notFoundContent={<span style={{ color: '#94a3b8' }}>该模型无可选比例</span>}
            />
          </Col>
        )}
      </Row>
